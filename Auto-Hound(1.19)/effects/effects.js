...
var loadedPages = [1]
const loadMorePages = () => {
    const bOsetLoadmr = document.getElementById('list-section-footer').offsetTop
    ...
    const aOsetLoadmr = document.getElementById('list-section-footer').offsetTop
    const diff = aOsetLoadmr - bOsetLoadmr
    console.log(diff);
...
const addingNewFilter = (info) => {
    ...
    const content = Mustache.render($rowtemplatefilter, {
        ...
        filterColor: filterColorSchema[info.filterNumber],
