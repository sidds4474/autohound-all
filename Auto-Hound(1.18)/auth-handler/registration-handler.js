...
const afterRgistrationAjax = (obj) => {
    ...
    if (obj.registrationSuccessfull) {
        const bdyWIdht = document.getElementsByClassName('body-wrapper')[0].offsetWidth
        ...
        document.getElementById('reg-footer').style.position = "absolute"
            // document.getElementById('reg-footer').style.marginLeft = "0"
            // document.getElementById('reg-footer').style.marginRight = "0"

        // if (bdyWIdht <= 1024) {
        //     document.getElementById('reg-footer').style.width = "100%"
        // } else {
        //     document.getElementById('reg-footer').style.width = "50%"
        // }
        // document.getElementById('reg-footer').style.width = "50%"
        // document.getElementById('reg-footer').style.left = "0"
        // document.getElementById('reg-footer').style.bottom = "0"
