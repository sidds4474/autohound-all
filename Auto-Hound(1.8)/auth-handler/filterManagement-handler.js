...
var arrObdii = ['Most Common Codes', 'Common Powertrain Codes', 'Common Chassis Codes', 'Common Body Codes', 'Common Network / Computer Codes']
            ...
            if (key === "excludeFilters") {
                ...
                k.forEach((key, index) => {
                    ...
                    if (key === "obdiiCodes") {
                        ...
                        data.forEach((v) => {
                            let isPresent = defaultObdiiOptions.indexOf(v)
                            if (isPresent === -1) {
                                arrObdii.push(v)
...
const getDataAndBtn = (clsname, values) => {
    ...
    btns.forEach((btn) => {
        ...
        let value = btn.children[2].innerHTML.trim()
