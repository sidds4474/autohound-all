        ...
        caption.forEach((captionVal) => {
                ...
                if (captionVal === "istrue") {
                    ...
                    if (userData.NOTIFICATION.istrue === "Yes") {
                        ...
                        document.getElementById('senstivityLevel').innerText = ""
                        document.getElementById('confirm-btn').setAttribute('disabled', 'disabled')
...
const checkFilterName = () => {
    ...
    if (!val || val === "") {
        ...
        document.getElementById('filter-name').style.border = "2px solid red"

    } else {
        document.getElementById('filter-name').style.border = "2px solid white"
        document.getElementById('filter-name').addEventListener('mouseover', (e) => {
            e.target.style.border = "2px solid #0266ff"
        })
        document.getElementById('filter-name').addEventListener('mouseout', (e) => {
            e.target.style.border = "2px solid white"
        })
        document.getElementById('filter-name').addEventListener('click', (e) => {
            e.target.style.border = "2px solid #0266ff"
        })
